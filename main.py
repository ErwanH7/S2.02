...
del sommet, temp, way #suppression des variables inutiles

#création de la matrice d'adjacence
sommets_list = list(dic_points.keys())
matriceAdjacence = pd.DataFrame(index=sommets_list, columns=sommets_list)
